...
// ========================================================================
// MCP Apps (SEP-1865) - Interactive UI Types
// ========================================================================
...
//
// Key SDK types:
// - App: Main widget application class
// - useApp: React hook for widget setup
// - CallToolResult: Result from app.callServerTool()
// - PostMessageTransport: Communication transport
//
// See mcp-apps/MCP_APPS_BEST_PRACTICES.md for implementation patterns.
